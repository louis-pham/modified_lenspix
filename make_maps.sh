...
while [ $i -lt $nz ]; do
    ...
    python lens.py lensing/kappa_z4pt6_z0.0_z${zmax}_nside2048_hp.fits cib/cib_fullsky_ns2048_zmin${zmincib}_zmax${zmaxcib}_nu217_tot.fits lensing/phi_z4pt6_z0.0_z${zmax}_nside2048_hp.fits cib/lensed_cib_fullsky_ns2048_zmin${zmincib}_zmax${zmaxcib}_nu217_tot.fits
