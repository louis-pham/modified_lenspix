...
kappa_map_file = "kappa_maps/8Gpc_n4096_nb23_nt18_kap_comb.fits"
...
lensed_file = "z4.6_combo_k_lmax5120_nside4096_interp1.5_method1_pol_1_lensed.fits" #map
...
hp.mollzoom(unlensed_map, title="Unlensed", xsize=2048, cmap=hot_cmap, min=-temp_bound, max=temp_bound, unit="muK")
hp.mollzoom(lensed_map, title="Lensed", xsize=2048, cmap=hot_cmap, min=-temp_bound, max=temp_bound, unit="muK")
