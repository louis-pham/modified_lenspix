...
unlensed_file = "/scratch2/r/rbond/phamloui/lenspix_files/output/may23_smooth_cmb_test_lmax5120_nside2048_interp1.5_method1_pol_1_unlensed_power.dat"
lensed_file = "/scratch2/r/rbond/phamloui/lenspix_files/output/may23_smooth_cmb_test_lmax5120_nside2048_interp1.5_method1_pol_1_lensed_power.dat"
...
#unlensed_cls = hp.alm2cl(hp.read_alm("/scratch2/r/rbond/phamloui/lenspix_files/FromNERSC/ffp10_unlensed_scl_cmb_000_alm.fits"))
#lensed_cls = hp.alm2cl(hp.read_alm("/scratch2/r/rbond/phamloui/lenspix_files/FromNERSC/ffp10_unlensed_scl_cmb_000_alm_gauss_smoothed.fits"))
...
#print ells
print unlensed_cls.shape
print unlensed_cls[:-100]
#print lensed_cls
...
plt.semilogy(ells, unlensed_cls, 'r', label="Unlensed", linewidth=1.0)
plt.semilogy(ells, lensed_cls, 'b', label="Lensed")
