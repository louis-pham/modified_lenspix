...
plt.loglog(ell[1:3001], primary_cl[1:3001], 'b', label="Unlensed")
plt.loglog(ell[1:3001], lensed_cl[1:3001], 'r', label="Simulation")
plt.loglog(ell[1:3001], lensed_theory_T[1:3001], 'g', label="Theory")
...
plt.plot(ell[1:3001], lensed_vs_primary[1:3001], 'r', label="Simulation vs Unlensed")
#plt.plot(camb_vs_lenspix, 'b', label="Lensed (CAMB) vs Lensed (Lenspix)")
plt.plot(ell[1:3001], lenspix_vs_primary[1:3001], 'g', label="Theory vs Unlensed")
